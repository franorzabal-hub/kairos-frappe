    ...
    <>
      <div className="flex items-center gap-1">
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-md px-2 py-1 text-sm font-medium text-muted-foreground bg-background shadow-sm hover:bg-accent hover:text-accent-foreground transition-colors flex-1 min-w-0 overflow-hidden"
        >
          <Command className="h-3.5 w-3.5 flex-shrink-0" />
          <span className="flex-1 text-left truncate">Quick actions</span>
          <kbd className="flex h-5 items-center rounded border bg-muted px-1.5 font-mono text-[10px] font-medium text-muted-foreground flex-shrink-0">
            ⌘K
          </kbd>
        </button>
        ...
        <button
          onClick={() => setOpen(true)}
          className="flex items-center gap-1.5 rounded-md px-2 py-1.5 text-muted-foreground bg-background shadow-sm hover:bg-accent hover:text-accent-foreground transition-colors"
        >
          <Search className="h-4 w-4" />
          <kbd className="flex h-4 min-w-4 items-center justify-center rounded border border-foreground/10 px-0.5 font-mono text-[10px] font-medium">
            /
          </kbd>
        </button>
      </div>
